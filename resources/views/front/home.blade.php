                ...
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            <!-- Start Single Slider -->
                            <div class="single-slider" style="background-image: url(https://picsum.photos/800/500);">
                                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner"
                                style="background-image: url('https://picsum.photos/370/250');">
                                <div class="content">
                                    <h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url('https://picsum.photos/620/340')">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                        style="background-image:url('https://picsum.photos/180/340')">
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            ...
                            <div class="single-product">
                                <div class="product-image">
                                    <img src="https://loremflickr.com/335/335" alt="#">
                                    <div class="button">
                    ...
                    <div class="single-banner right"
                        style="background-image:url('https://loremflickr.com/730/310');margin-top: 30px;">
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            <img src="https://loremflickr.com/510/600" alt="#">
        ...
        <script>
            ...
            const timer = () => {
                ...
                if (diff < 0) {
                    ...
                    document.querySelector(".container-fixed").style.display = 'none';
                }
